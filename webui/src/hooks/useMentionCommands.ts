...
export const SLASH_COMMANDS: MentionEntity[] = [
  {
    ...
    category: 'action',
    categoryLabel: '快捷指令',
    description: '智能多源采集 (如: /crawl 关键词 平台)',
    command: '/crawl',
  },
  {
    id: 'cmd_report',
  ...
  },
  {
    ...
    category: 'action',
    categoryLabel: '快捷指令',
    description: '导出当前采集数据 (Excel/CSV/Markdown)',
    command: '/export',
  },
  {
    id: 'cmd_status',
