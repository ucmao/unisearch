...
# Repository: https://github.com/NanmiCoder/MediaRadar/blob/main/store/weibo/__init__.py
...
async def update_weibo_note(note_item: Dict):
    ...
    # 本地个人分析模式：creator_hash 兼容字段保存原始 user_id，昵称保存原文；
    ...
    save_content_item = {
        ...
        "creator_hash": preserve_user_id(user_info.get("id")),
        "nickname": preserve_nickname(user_info.get("screen_name", "")),
