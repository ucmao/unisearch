...
# Repository: https://github.com/NanmiCoder/MediaRadar/blob/main/store/douyin/__init__.py
...
async def update_douyin_aweme(aweme_item: Dict):
    ...
    save_content_item = {
        ...
        "creator_hash": preserve_user_id(user_info.get("uid")),  # 原始平台用户 ID
        "nickname": preserve_nickname(user_info.get("nickname")),  # 原始昵称
