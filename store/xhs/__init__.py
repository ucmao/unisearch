...
# Repository: https://github.com/NanmiCoder/MediaRadar/blob/main/store/xhs/__init__.py
...
async def update_xhs_note(note_item: Dict):
    ...
    local_db_item = {
        ...
        "creator_hash": preserve_user_id(user_info.get("user_id")),  # 原始平台用户 ID
        ...
        "last_modify_ts": utils.get_current_timestamp(),  # Last modification timestamp (Generated by MediaRadar, mainly used to record the latest update time of a record in DB storage)
