...
# Repository: https://github.com/NanmiCoder/MediaRadar/blob/main/tools/browser_launcher.py
...
class BrowserLauncher:
    ...
    def launch_browser(self, browser_path: str, debug_port: int, headless: bool = False,
        ...
        args = [
            ...
            "--remote-debugging-address=127.0.0.1",  # Local remote access to prevent security prompts
            "--no-first-run",
