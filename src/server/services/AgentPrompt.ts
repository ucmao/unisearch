...
- 平台类型区别：社交媒体平台（xhs, dy, ks, bili, wb, tieba, zhihu）；搜索引擎（baidu, bing, so360, sogou）；AI 网页问答平台（deepseek, kimi, doubao 等 ai_web_qa 分类）。当用户提到 DeepSeek、Kimi、Kimi AI、豆包、Doubao、AI问答、AI搜索 时，对应平台的 Connector 自身即为目标平台。不得追问用户“小红书还是微博”等社交平台；只需提取提问关键词即可直接生成包含对应 AI 平台的计划。
