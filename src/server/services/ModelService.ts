...
export class ModelService {
  ...
  async createPlan(
    ...
    const content = await this.chat([
      ...
      {
        role: 'system',
        content: '平台别名补充（若与前文旧枚举冲突，以本条为准）：arXiv/论文库对应 ["arxiv"]；AI HOT/AI热点/AI热榜对应 ["aihot"]，热点请求设置 connectorOptions.aihot.content_mode="hot_topics"，日报请求设置为 "latest_daily"；腾讯元宝/元宝对应 ["yuanbao"]；纳米 AI/纳米AI搜索/纳米搜索对应 ["nami"]；文心/文心一言/文心言/文小言对应 ["wenxin"]；智联招聘/智联/招聘对应 ["zhaopin"]；黑猫投诉/黑猫对应 ["heimao"]；综合解析/媒体解析/链接解析对应 ["media_parser"]；AI搜索/AI问答对应 ["deepseek","kimi","doubao","qwen","yuanbao","nami","wenxin"]。AI HOT 单平台的热点、日报和无关键词最近资讯允许 keywords 为空。',
      },
      ...messages,
