...
补充：当用户提到“GitHub”、“GitHub 仓库”或“GitHub 趋势”时对应 ["github_repositories"]；AI GitHub 趋势设置 connectorOptions.github_repositories.mode="ai"。
