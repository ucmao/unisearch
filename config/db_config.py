...
# Repository: https://github.com/NanmiCoder/MediaRadar/blob/main/config/db_config.py
...
if getattr(sys, 'frozen', False):
    # Packaged environment (e.g. Electron + PyInstaller)
    ...
    SQLITE_DB_PATH = os.path.join(app_dir, "analytics.sqlite3")
else:
    # Development environment
    SQLITE_DB_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), "data", "analytics.sqlite3")
