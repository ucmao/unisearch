...
# Repository: https://github.com/NanmiCoder/MediaRadar/blob/main/config/base_config.py
...
# 程序结束时是否自动关闭浏览器
# 仅适用于程序自行启动的独立浏览器；连接已有浏览器时始终保留 Chrome
# 设置为 False 可以保持独立浏览器运行，方便调试
...
SAVE_DATA_OPTION = "sqlite"  # SQLite is the single source of truth; use exports for files.
