...
# Repository: https://github.com/NanmiCoder/MediaRadar/blob/main/media_platform/zhihu/help.py
...
class ZhihuExtractor:
    ...
    def _extract_content_or_comment_author(author: Dict) -> ZhihuCreator:
        ...
        try:
            ...
            res.creator_hash = preserve_user_id(author.get("id"))
            res.user_nickname = preserve_nickname(author.get("name"))
    ...
    def extract_creator(self, user_url_token: str, html_content: str) -> Optional[ZhihuCreator]:
        ...
        res = ZhihuCreator()
        res.creator_hash = preserve_user_id(creator_info.get("id"))
        res.user_nickname = preserve_nickname(creator_info.get("name"))
